...
async function collectReportInput(tenantId, type, periodStart, periodEnd, agentIds) {
 ...
 */
export async function generateReport({ tenantId, type, periodStart, periodEnd, agentIds = [] }) {

...
每阶段的产出（市场分析报告、17 章策划案、素材清单、双文档）必须以**完整 markdown 内容**直接出现在 assistant 消息中。
...
> 本契约 v1.0 与 skill 包 sha256 头 `375f242d`（2026-04-29 patch 版本）配套生效。后续版本升级会同步更新本文件版本号。

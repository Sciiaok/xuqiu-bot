...
/**
 * Get leads for a conversation, optionally filtered by route.
 * @param {string} conversationId - Conversation UUID
 * @param {string|null} [route='CONTINUE'] - Route to filter by; pass `null` to
 *   return every lead regardless of route (会话级动作如 FAQ_END 收尾用)。

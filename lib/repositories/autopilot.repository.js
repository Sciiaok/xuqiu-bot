/**
 * Autopilot repository — CRUD for autopilot_sessions + autopilot_messages.
 *
...
export async function createSession({ userId = null, title = null } = {}) {
...
export async function listSessions({ userId = null, limit = 50 } = {}) {
  let query = supabase
    .from('autopilot_sessions')
